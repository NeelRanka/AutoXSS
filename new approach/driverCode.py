...
def CheckXSS(BaseUrl,depth):
	...
	try:
		...
		if Recursive:
			currentDomainLinks.append(  ( links, depth+1 )  )
...
#if static
#Code for Static here
#new approach uses BFS and needs some optimization for figuring blocg like web pages so that it does not check for all of such pages on a route
